...
# Make Apache listen on Render-compatible port
...
# IMPORTANT:
# Do NOT run Laravel cache:clear / optimize:clear here.
# Those commands can attempt to connect to SQL Server during image build.
