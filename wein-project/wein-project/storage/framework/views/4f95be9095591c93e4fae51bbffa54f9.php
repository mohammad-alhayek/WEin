<?php $__env->startSection('title', __('messages.edit') . ' — ' . $product->title); ?>

<?php $__env->startSection('content'); ?>
<div class="page-header">
    <h1><?php echo e(__('messages.edit')); ?>: <?php echo e($product->title); ?></h1>
    <a href="<?php echo e(route('admin.instant-orders.index')); ?>" class="btn btn-secondary">← <?php echo e(__('messages.back')); ?></a>
</div>

<div class="card" style="max-width:700px">
    <div class="card-body">
        <form method="POST" action="<?php echo e(route('admin.instant-orders.update', $product)); ?>">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="url" name="product_url" class="form-control" value="<?php echo e(old('product_url', $product->product_url)); ?>">
                </div>
                <div class="form-group">
                    <label class="form-label"><?php echo e(__('messages.image_url')); ?></label>
                    <input type="url" name="image_url" class="form-control" value="<?php echo e(old('image_url', $product->image_url)); ?>">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="delivery_price" class="form-control" value="<?php echo e(old('delivery_price', $product->delivery_price)); ?>" step="0.01" min="0" required>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group">
                    <label class="form-label"><?php echo e(__('messages.quantity')); ?></label>
                    <input type="number" name="quantity" class="form-control" value="<?php echo e(old('quantity', $product->quantity)); ?>" min="0" required>
                </div>
                <div class="form-group">
                    <label class="form-label"><?php echo e(__('messages.status')); ?></label>
                    <select name="status" class="form-control">
                        <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($s); ?>" <?php echo e(old('status', $product->status) === $s ? 'selected' : ''); ?>><?php echo e(__('messages.' . $s)); ?></option>
            ...
            <div class="form-group">
                ...
                <textarea name="specifications" class="form-control"><?php echo e(old('specifications', $product->specifications)); ?></textarea>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Downloads\wein-project\wein-project\resources\views/admin/instant-orders/edit.blade.php ENDPATH**/ ?>