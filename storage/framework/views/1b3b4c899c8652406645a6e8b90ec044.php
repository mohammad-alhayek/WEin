<?php $__env->startSection('title', __('messages.create') . ' ' . __('messages.order')); ?>

<?php $__env->startSection('content'); ?>
<div class="page-header">
    <h1><?php echo e(__('messages.create')); ?> <?php echo e(__('messages.order')); ?></h1>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="date" name="expected_arrival_date" class="form-control" value="<?php echo e(old('expected_arrival_date')); ?>">
                </div>
                <div class="form-group">
                    <label class="form-label"><?php echo e(__('messages.tax')); ?></label>
                    <input type="number" name="tax" class="form-control" value="<?php echo e(old('tax', 0)); ?>" step="0.01" min="0">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="d-flex gap-1" style="margin-top:1rem">
                ...
                <a href="<?php echo e(route('admin.orders.index')); ?>" class="btn btn-secondary"><?php echo e(__('messages.cancel')); ?></a>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\wein-project 0.9\wein-projectzip\resources\views/admin/orders/create.blade.php ENDPATH**/ ?>